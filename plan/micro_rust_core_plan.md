...
| **Симметричный шифр** | ***REDACTED-BY-FILTER-REPO*** (RFC 8439, 12 байт nonce, 16 байт Poly1305 tag) | `chacha20poly1305 = "0.10"` |
...
└── penik-crypto/
    ...
    └── src/
        ...
        ├── cipher.rs             # ***REDACTED-BY-FILTER-REPO*** шифрование/дешифрование
...
- [ ] Реализовать `kdf.rs` и `cipher.rs`: HKDF с `info="penik-pairwise-message-v1"` и шифрование ***REDACTED-BY-FILTER-REPO***.
