...
- `.github/workflows/android.yml` — GitHub Actions workflow assembling `app-debug.apk`, publishing rolling `android-latest` GitHub release, and uploading artifacts on pushes to `master` and manual trigger.
