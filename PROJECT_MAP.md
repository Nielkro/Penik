...
- `desktop/screencap.go` — High-performance desktop screen and window capture engine streaming raw I420/RGBA frames directly to native VP8 encoder and serving non-blocking 2 FPS lightweight JPEG preview over local WebSocket.
