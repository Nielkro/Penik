...
- `client/js/crypto.js` — Implements browser cryptography: X25519, HKDF, ***REDACTED-BY-FILTER-REPO***, direct message E2EE, signatures, safety numbers, key backups, and group encryption.
...
- `tests/e2e/crypto_utils.py` — Python cryptographic helper implementing X25519 key pairs, Diffie-Hellman derivation, pairwise AAD construction, ***REDACTED-BY-FILTER-REPO*** encryption/decryption, file crypto, and safety fingerprinting.
