...
- `.github/workflows/android.yml` — GitHub Actions workflow assembling `app-debug.apk`, publishing immutable `android-v<version>` GitHub releases based on `version.json`, and uploading build artifacts on pushes to `master`.
