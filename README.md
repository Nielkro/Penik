...
| Криптография | X25519, HKDF, ***REDACTED-BY-FILTER-REPO***, AES-GCM, PBKDF2 (600k итераций в Rust), Zeroize очистка RAM, TOFU Key Pinning, Pairwise AAD v2 |
...
rust/            Нативное ядро penik-crypto: X25519, ***REDACTED-BY-FILTER-REPO***, KDF, Zeroize, JNI, C-ABI, WASM
